...
class Ui_ClinicData(object):
    def setupUi(self, ClinicData):
        ...
        self.texto_boasvindas.setText("Novo administrador")
        ...
        try:
            ...
            #Label - Função
            self.texto_funcao = QtWidgets.QLabel(self.centralwidget)
            self.texto_funcao.setGeometry(QtCore.QRect(775, 170, 55, 20))
            font = QtGui.QFont()
            font.setPointSize(12)
            self.texto_funcao.setFont(font)
            self.texto_funcao.setStyleSheet("background: white; color: #A6A6A6;")
            self.texto_funcao.setAlignment(QtCore.Qt.AlignCenter)
            self.texto_funcao.setObjectName("texto_funcao")
            self.texto_funcao.setText("Função")
            ...
            self.texto_erro.setGeometry(QtCore.QRect(30, 630, 220, 16))
            ...
            #Input 5
            self.input_5 = QtWidgets.QComboBox(self.centralwidget)
            ...
            self.input_5.addItem("PROFISSIONAL")
            self.input_5.addItem("RECEPÇÃO/ADMINISTRAÇÃO")
            ...
            def funcao_enviar():
                ...
                funcao = str(self.input_5.currentText()).upper()
                ...
                if senha == '' or nome == '' or usuario == '' or email == '':
                    ...
                    if num != 0:
                        ...
                        manipulador.execute(f'INSERT INTO administradores(nome,senha,email,usuario,funcao) VALUES("{nome}","{senha}","{email}","{usuario}","{funcao}")')
                        self.texto_erro.setText("")
